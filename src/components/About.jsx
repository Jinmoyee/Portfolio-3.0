    ...
    return (
        <div className="dark:text-white h-full mb-20">
            <motion.h1 
                ...
                className='text-3xl font-thin text-center mb-6 md:text-4xl lg:text-5xl'>About Me</motion.h1>
            ...
            <div className='flex items-center justify-center flex-col lg:justify-around lg:flex-row gap-5'>
                <div className='my-image'>
                    <motion.img
                        ...
                        src={Pic2} alt="" className="h-[15rem] w-[20rem] sm:h-[20rem] sm:w-[25rem] lg:h-[20rem] lg:w-[30rem] xl:h-[25rem] xl:w-[35rem] ml-0 lg:ml-20 rounded-lg" />
                </div>
