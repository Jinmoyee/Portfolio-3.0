    ...
    return (
        <div className="dark:text-white h-full">
            <motion.h1
                ...
                className='text-3xl font-thin text-center mb-6 md:text-4xl lg:text-5xl mt-5 lg:mt-0'>Projects</motion.h1>
                ...
                <div className='my-image'>
                    <a href="https://jt-estate.onrender.com/" target="_blank">
                        <motion.img
                            ...
                            transition={{ duration: 1.5 }}
                            src={Pic1} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
                    initial={{ x: 100, opacity: 0 }}
                    transition={{ duration: 1.5 }}
                    className='w-[95%] sm:w-[80%] md:w-[60%] lg:w-[45%] mt-4 lg:mt-0'>
                    <div className='about'>
                ...
                <div className='my-image'>
                    <a href="https://real-time-chat-app-h84z.onrender.com/" target="_blank">
                        <motion.img
                            ...
                            initial={{ x: -100, opacity: 0 }}
                            transition={{ duration: 1.5 }}
                            src={Pic2} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
                ...
                <div className='my-image'>
                    <a href="https://jinmoyee.github.io/HTML-CSS-Shopping-Website/index.html" target="_blank">
                        <motion.img
                            ...
                            initial={{ x: -100, opacity: 0 }}
                            transition={{ duration: 1.5 }}
                            src={Pic3} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
                ...
                <div className='my-image'>
                    <a href="https://jinmoyee.github.io/Blog-HTML-AND-CSS-Website/" target="_blank">
                        <motion.img
                            ...
                            initial={{ x: -100, opacity: 0 }}
                            transition={{ duration: 1.5 }}
                            src={Pic4} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
                ...
                <div className='my-image'>
                    <a href="https://jinmoyee.github.io/Restaurant-HTML-AND-CSS-Website/" target="_blank">
                        <motion.img
                            ...
                            initial={{ x: -100, opacity: 0 }}
                            transition={{ duration: 1.5 }}
                            src={Pic5} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
                ...
                <div className='my-image'>
                    <a href="https://jinmoyee.github.io/Parallax-HTML-AND-CSS-Website/" target="_blank">
                        <motion.img
                            ...
                            initial={{ x: -100, opacity: 0 }}
                            transition={{ duration: 1.5 }}
                            src={Pic6} alt="" className="w-[18rem] sm:w-[20rem] ml-0 lg:ml-20 rounded-lg" />
                    </a>
                </div>
                <motion.div
                    whileInView={{ x: 0, opacity: 1 }}
